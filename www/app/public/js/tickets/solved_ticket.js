...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (selectedProduct) {
    ...
    // Appeler solvedTickets avec le produit actuellement sélectionné
...
function solvedTickets(selectedProduct) {
  ajaxRequest("GET", `/ticketsApp/config/routes.php/solved/${selectedProduct}`, function (response) {
    updateTickets(response, selectedProduct); // Utilisez le bon nom de variable ici
  });
}
function updateTickets(html, selectProduct) {
