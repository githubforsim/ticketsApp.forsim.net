...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (selectedProduct) {
      ...
      // NE PAS appeler eventTicket au chargement car les événements sont déjà chargés côté serveur
      // eventTicket(selectedProduct);
  } else {
...
function eventTicket(selectedProduct) {
  ajaxRequest("GET", `/ticketsApp/config/routes.php/user-event/${selectedProduct}`, updateTickets);
}
