...
if (strpos($currentUrl, '/app/src/Views/admin/tickets/open_tickets_view.php') !== false) {
    header('Location: /ticketsApp/admin/tickets/open', true, 301);
    exit;
}
      ...
      <table class="ticketTable">
        ...
        <tbody id="ticketTableBody">
          ...
          <?php foreach ($tickets as $ticket): ?>
            <tr>    
              <!-- URL masquée pour les détails des tickets -->
              <?php $detailsSaveUrl = '/ticketsApp/admin/tickets/details/' . $ticket['ticket_id'] ?>
