...
<html lang="fr">
  <head>
    ...
    <link rel="stylesheet" href="/app/public/css/tickets/details/solved_details.css?v=2.4" />
  ...
  <body>
    ...
    <div class="content">
    <a class="open_btn" href="/ticketsApp/admin_solved_details/<?= htmlspecialchars($ticket['ticket_id']) ?>">Ticket</a>
    <a class="solved_btn" href="/ticketsApp/ticket-message-solved-admin/<?= htmlspecialchars($ticket['ticket_id']) ?>">Chat</a>
    <?php
if (is_array($ticket)) {
  extract($ticket);
} else {
  ...
  exit;
    ...
    <div id="ticket_details">
      ...
      <div id="buttons">
        ...
        <div id="close_btn">
<a href="/ticketsApp/admin/tickets/solved" class="submit"><i class="fa fa-times"></i> Fermer</a>
        </div>
        </div>
            ...
            <?php foreach ($evenements as $evenement): ?>
                <tr>
                   <?php
                    ...
                    $chatUrl = "/ticketsApp/ticket-message-solved-admin/" . $evenement['ticket_id'];
                    ...
                    <td class="num"><?= htmlspecialchars($evenement['evenement_id']) ?></td>
...
<script type="text/javascript" src="/app/public/js/admin/details/solved_details.js" defer></script>
