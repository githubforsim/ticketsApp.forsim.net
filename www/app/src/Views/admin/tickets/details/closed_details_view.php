...
<html lang="fr">
  <head>
    ...
    <link rel="stylesheet" href="/ticketsApp/app/public/css/tickets/details/closed_details.css" />
  ...
  <body>
    ...
    <div id="ticket_details">
      ...
      <div id="buttons">
        <div id="close_btn">
          <a href="/ticketsApp/admin/tickets/closed" class="submit"><i class="fa fa-times"></i> Fermer</a>
        </div>
      </div>
    </div>
    <table class="ticketTable">
            ...
            <?php foreach ($evenements as $evenement): ?>
                <tr>
                    ...
                    $chatUrl = "/ticketsApp/ticket-message-closed-admin/" . $evenement['ticket_id'];
...
<script type="text/javascript" src="/ticketsApp/app/public/js/admin/details/closed_details.js" defer></script>
