  ...
  <body>
    ...
    <div id="ticket_details">
      ...
      <div id="buttons">
        ...
        <div id="close_btn">
          <a href="/app/src/Views/tickets/solved_tickets_view.php" class="submit"><i class="fa fa-times"></i> Fermer</a>
        </div>
        </div>
...
<script type="text/javascript" src="/app/public/js/tickets/details/solved_details.js" defer></script>
