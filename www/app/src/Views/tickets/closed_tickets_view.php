<?php
// 3. FICHIER closed_tickets_view.php CORRIGÉ
...
<head>
    ...
    <link rel="stylesheet" href="/app/public/css/tickets/closed_ticket.css?v=2.4" />
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css" />
    <title>Tickets fermés</title>
</head>
<body>
            ...
            <tbody id="ClosedTableBody">
                ...
                <?php foreach ($tickets as $ticket): ?>
                    <tr>    
                        ...
                        <?php $detailsSaveUrl = '/ticketsApp/tickets/closed_details/' . $ticket['ticket_id'] ?>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="7">Aucun tickets fermés trouvé.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
    ...
    <script type="text/javascript" src="/app/public/js/tickets/closed_ticket.js" defer></script>
</body>
</html>